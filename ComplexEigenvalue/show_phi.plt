...
set label 1 \
 "----- calculation parameters -----\n \
  ...
  init func : 1st excitedstate\n \
   (S = 0.9, X = -0.5)\n \
  V_{opt}(x) = x*x" \
 front at first -2.5, 0.015

set label 2 "-1.02 - 0.0i" front at first -1.2, 0.01 tc rgb "white"
set label 3 "-0.155 + 0.0i" front at first -0.4, 0.01 tc rgb "white"
#set label 4 "-0.155 - 0.0052i" front at first -0.4, -0.015 tc rgb "white"
