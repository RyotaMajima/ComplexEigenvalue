...
set label 2 "-1.02 - 0.011i" front at first -1.15, 0.0 tc rgb "white"
set label 3 "-0.156 - 0.0086i" front at first -0.4, 0.0 tc rgb "white"
...
set title "{/Symbol e} = -1.02 - 0.011i"
...
set title "{/Symbol e} = -0.156 - 0.0086i"
pl "./output/output_phi.txt" us 1:2 w l ti "V(x)" lc rgb "black" lw 2, \
